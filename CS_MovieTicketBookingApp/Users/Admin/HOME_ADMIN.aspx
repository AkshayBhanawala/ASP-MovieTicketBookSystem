<%@ Page Language="C#" MasterPageFile="~/Master_Pages/MasterPage_Login_Admin.master" AutoEventWireup="True" CodeBehind="~/HOME.aspx.cs" Inherits="CS_MovieTicketBookingApp.HOME"%>

<asp:Content ID="HEAD_HOME_ADMIN_CONTENT" ContentPlaceHolderID="SUB_HEAD_LOGIN_ADMIN_CONTENTPLACEHOLDER" Runat="Server">
	<title>ADMIN HOME PAGE</title>
</asp:Content>
<asp:Content ID="BODY_HOME_ADMIN_CONTENT" ContentPlaceHolderID="SUB_BODY_LOGIN_ADMIN_CONTENTPLACEHOLDER" Runat="Server">
	<h1>MOVIES</h1>
    <hr>
