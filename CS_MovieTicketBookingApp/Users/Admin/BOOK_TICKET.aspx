<%@ Page Language="C#" MasterPageFile="~/Master_Pages/MasterPage_Login_Admin.master" AutoEventWireup="True" CodeBehind="~/Users/BOOK_TICKET.aspx.cs" Inherits="CS_MovieTicketBookingApp.Users.BOOK_TICKET" %>

<asp:Content ID="HEAD_BOOK_TICKET_CONTENT" ContentPlaceHolderID="SUB_HEAD_LOGIN_ADMIN_CONTENTPLACEHOLDER" Runat="Server">
...
<asp:Content ID="BODY_BOOK_TICKET_CONTENT" ContentPlaceHolderID="SUB_BODY_LOGIN_ADMIN_CONTENTPLACEHOLDER" Runat="Server">
    <center>
        <br><br>
<div class="div_form">
        <table>
