<%@ Page Language="C#" MasterPageFile="~/Master_Pages/MasterPage_Login_Admin.master" AutoEventWireup="True" CodeBehind="~/Users/Admin/Management/MOVIE_UPDATE.aspx.cs" Inherits="CS_MovieTicketBookingApp.Users.Admin.Management.MOVIE_UPDATE" %>
...
<asp:Content ID="BODY_MOVIE_ADD_CONTENT" ContentPlaceHolderID="SUB_BODY_LOGIN_ADMIN_CONTENTPLACEHOLDER" Runat="Server">
    ...
    <div class="div_form">
        <table>
            ...
            <tr><td colspan="3"><hr /></td></tr>
            <tr>
                <td class="text"> MOVIE:- </td>
                <td>
                    <asp:DropDownList ID="DDL_MOVIE_ID" runat="server" AutoPostBack="True" CssClass="input_field_initial" OnSelectedIndexChanged="DDL_MOVIE_ID_SelectedIndexChanged" OnDataBound="DDL_MOVIE_ID_DataBound" />
                </td>
                <td></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td align="center">
                    ...
                    <asp:Calendar ID="CAL_RELEASE_DATE" runat="server" BackColor="#bbbbbb"
                        visible="False" Caption="RELEASE DATE" CaptionAlign="Top" CellPadding="0"
            ...
            <tr>
                <td class="text"> CURRENT COVER IMAGE:- </td>
                <td>
                    <br>
                    <asp:Image ID="IMG_CURRENT_COVER_IMAGE" runat="server" Width="200" Height="300" />
                </td>
                <td>&nbsp;</td>
            </tr>
            <tr>
                <td class="text"> NEW COVER IMAGE:- </td>
                <td>
            ...
            <tr>
                <td>&nbsp;</td>
                <td align="center">
                    <asp:Button ID="BTN_UPDATE_MOVIE" runat="server" CssClass="button_green" text="UPDATE MOVIE" ValidationGroup="VG1" OnClick="BTN_UPDATE_MOVIE_Click" />
