<%@ Page Language="C#" MasterPageFile="~/Master_Pages/MasterPage_Login_User.master" AutoEventWireup="True" CodeBehind="~/HOME.aspx.cs" Inherits="CS_MovieTicketBookingApp.HOME"%>

<asp:Content ID="HEAD_HOME_USER_CONTENT" ContentPlaceHolderID="SUB_HEAD_LOGIN_USER_CONTENTPLACEHOLDER" Runat="Server">
	<title>USER HOME PAGE</title>
</asp:Content>
<asp:Content ID="BODY_HOME_USER_CONTENT" ContentPlaceHolderID="SUB_BODY_LOGIN_USER_CONTENTPLACEHOLDER" Runat="Server">
	<h1>MOVIES</h1>
    <hr>
